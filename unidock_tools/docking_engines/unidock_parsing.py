    ...
    for docked_conf_idx in range(num_docked_conformations):
        ...
        for current_docked_conf_line in current_docked_conf_line_block:
            ...
            if current_docked_conf_line_splited_list[0] == 'ATOM':
                ...
                if current_docked_conf_line_splited_list[1] == 'VINA' and current_docked_conf_line_splited_list[2] == 'RESULT:':
...
def generate_docking_pose_sdf_files(working_dir_name,
    ...
    for pose_idx in range(num_docked_poses):
        ...
        docked_mol.SetProp('unidock_binding_free_energy', str(docked_conf_binding_free_energy))
        docked_mol.SetProp('unidock_ligand_efficiency', str(docked_conf_ligand_efficiency))
        ...
        docked_mol = Chem.AddHs(docked_mol_no_h, addCoords=True)
        ################################################################################################################################################

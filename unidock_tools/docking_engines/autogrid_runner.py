...
from xdatools.modules.docking_engines.docking_grids_generator import DockingGridsGenerator
...
class AutoGridRunner(object):
    def __init__(self,
        ...
        os.environ['MGLPY'] = os.environ.get('MGLPY', '/data/aidd-server/Modules/mgltools_x86_64Linux2_1.5.6/bin/python')
        os.environ['MGLUTIL'] = os.environ.get('MGLUTIL', '/data/aidd-server/Modules/mgltools_x86_64Linux2_1.5.6/MGLToolsPckgs/AutoDockTools/Utilities24')
